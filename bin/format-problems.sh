...
FILES=$(grep "import com.github.ked4ma.atcoder.utils" src/main/java/com/github/ked4ma/atcoder/problems/Code.kt | \
        grep -v debug | \
        awk -F' ' '{print "src/main/java/"$2}' | \
        sed 's|\.|/|g' | \
        sed 's/\*/Code.kt/')
awk 1 src/main/java/com/github/ked4ma/atcoder/problems/Code.kt $(echo $FILES) | \
